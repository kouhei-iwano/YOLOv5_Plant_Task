...
Usage:
    $ python detect.py --source path/to/image.jpg --weights path/to/model.pt --img 1472
"""
...
def parse_opt():
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=1472, help='inference size (pixels)')
